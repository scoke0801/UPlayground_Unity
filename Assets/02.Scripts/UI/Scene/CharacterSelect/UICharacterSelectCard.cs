...
namespace UPlayGround.UI
{
    ...
    /// </summary>
    public class UICharacterSelectCard : MonoBehaviour,
        ISelectHandler,
        IDeselectHandler,
        IUIFocusPresentation
    {
        ...
        public void Init(UI_Scene_CharacterSelect parent, int index, CharacterActorType type, string displayName, Sprite portrait, bool locked)
        {
            _parent = parent;
            _index = index;
            _characterType = type;
