...
namespace UPlayGround.UI
{
    ...
    public class UI_Scene_PartySelect : UI_Base
    {
        ...
        [SerializeField] private UIPartyMemberSlot _rosterSlotPrefab;
        ...
        private readonly List<UIPartyMemberSlot> _slots = new();
        private readonly List<UIPartyMemberSlot> _rosterSlots = new();
        ...
        private void SetSlotCount(int count)
        {
            ...
            {
                UIPartyMemberSlot slot = Instantiate(_slotPrefab, _slotRoot);
                _slots.Add(slot);
            }
        ...
        private void SetRosterSlotCount(int count)
        {
            ...
            UIPartyMemberSlot prefab = _rosterSlotPrefab != null ? _rosterSlotPrefab : _slotPrefab;
            if (prefab == null || root == null) return;

            while (_rosterSlots.Count < count)
            {
                UIPartyMemberSlot slot = Instantiate(prefab, root);
