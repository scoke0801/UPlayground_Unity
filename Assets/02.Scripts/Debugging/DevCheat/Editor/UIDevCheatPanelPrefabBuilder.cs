...
namespace UPlayGround.UI.DevCheat.EditorTools
{
    ...
    ///   있으면 자식 계층만 재구성(멱등).
    /// - 골격(헤더/좌측 탭 레일/탭 콘텐츠 컨테이너 7개/하단 로그 바)만 구성한다.
    ...
    public static class UIDevCheatPanelPrefabBuilder
    {
        ...
        private static readonly string[] TabLabels = { "기즈모", "아이템", "퀘스트", "플레이어 스텟", "파티원", "시간", "전투" };
        ...
        [MenuItem("UPlayGround/UI/개발 치트 패널 프리팹 빌드 (초안)")]
