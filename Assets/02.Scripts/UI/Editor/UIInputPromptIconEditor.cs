...
{
    /// <summary>
    /// UIInputPromptIcon 인스펙터에 "글리프 미리보기" 패널을 추가하는 커스텀 에디터.
    ///
    /// - 런타임 IInputService/씬 없이 PlayerInputActions 에셋을 직접 로드해 해석한다.
    ...
    /// </summary>
    [CustomEditor(typeof(UIInputPromptIcon))]
    public class UIInputPromptIconEditor : UnityEditor.Editor
    {
