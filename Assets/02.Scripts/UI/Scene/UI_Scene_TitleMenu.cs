...
namespace UPlayGround.UI
{
    ...
    public class UI_Scene_TitleMenu : UI_SceneBase
    {
        ...
        private UI_Scene_CharacterSelect _characterSelect;
        ...
        private void OnClickLoadButton()
        {
            ...
            go?.GetComponent<UI_Scene_SaveSlotMenu>()?.SetMode(UI_Scene_SaveSlotMenu.SaveSlotMode.Load);
        }
        ...
        private void OnClickNewGameButton()
        {
            ...
            var go = UISvc.UI.ShowUI(UI_Scene_CharacterSelect.UIKey);
            _characterSelect = go != null ? go.GetComponent<UI_Scene_CharacterSelect>() : null;
            if (_characterSelect == null)
            {
                Debug.LogError("[UI_Scene_TitleMenu] 캐릭터 선택 UI가 없어 새 게임을 시작할 수 없습니다.");
                return;
            }
        ...
        private void StartNewGame(CharacterActorType selectedCharacter)
        {
            ...
            {
                Debug.LogError("[UI_Scene_TitleMenu] 시작 캐릭터가 선택되지 않아 새 게임을 중단합니다.");
                Show();
                return;
            }
        ...
        private void LoadStartScene()
        {
            ...
            {
                Debug.LogError("[UI_Scene_TitleMenu] 시작 씬이 지정되지 않았습니다. " +
