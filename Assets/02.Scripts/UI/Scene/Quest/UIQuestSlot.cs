...
namespace UPlayGround.UI
{
    /// <summary>
    /// 퀘스트 메뉴 — 좌측 리스트 슬롯 1개.
    /// UI_Scene_QuestMenu의 리스트에서 Instantiate해 사용한다.
    /// </summary>
    public class UIQuestSlot : MonoBehaviour, IPointerClickHandler, ISelectHandler,
        IUIFocusPresentation
    {
        ...
        private UI_Scene_QuestMenu _parent;
        ...
        public void Init(QuestSO so, QuestStatus status, bool tracked, UI_Scene_QuestMenu parent)
        {
            _questId = so.questId;
            _status  = status;
            _parent  = parent;
