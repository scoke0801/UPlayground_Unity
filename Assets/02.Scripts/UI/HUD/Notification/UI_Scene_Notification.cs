...
namespace UPlayGround.UI.HUD.Notification
{
    ...
    /// </summary>
    public class UI_Scene_Notification : UI_Base
    {
        ...
        [SerializeField] private UINotificationEntry _entryPrefab;
        ...
        private readonly List<UINotificationEntry> _entries = new();
        ...
        public static UI_Scene_Notification ShowSystemMessage(string title, string message, Sprite icon = null)
        {
        ...
        public static UI_Scene_Notification ShowQuestCompleted(string questName)
        {
            var ui = EnsureVisible();
        ...
        public static UI_Scene_Notification ShowPartyMemberUnlocked(CharacterActorType type)
        {
            var ui = EnsureVisible();
            if (ui == null)
                return null;
        ...
        public void ShowMessage(string title, string message, Sprite icon = null, Color? accentColor = null)
        {
            ...
            {
                Debug.LogWarning("[UI_Scene_Notification] Entry 프리팹이 연결되지 않았습니다.");
                return;
            }
        ...
        private static UI_Scene_Notification EnsureVisible()
        {
            if (UISvc.UI == null)
                return null;

            var obj = UISvc.UI.ShowUI(UIKeyType.Notification, CanvasLayer.HUD);
            return obj != null ? obj.GetComponent<UI_Scene_Notification>() : null;
        }
