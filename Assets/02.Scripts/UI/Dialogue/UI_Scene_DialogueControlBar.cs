...
namespace UPlayGround.UI
{
    ...
    /// </summary>
    public class UI_Scene_DialogueControlBar : UI_Base
    {
        [Header("버튼")]
        ...
        // (입력 독점은 이미 UI_Scene_Dialogue/UI_Scene_MonologueDialogue가 담당한다.)
        ...
        // 커서는 대화 본체(UI_Scene_Dialogue)가 이미 표시 상태로 push하므로 마우스 클릭에는 영향이 없다.
