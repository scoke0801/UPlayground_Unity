...
**고정된 플레이어 시작점**에서 출발해, 수작업 검증된 N개 외곽 후보에서 보스 위치를 결정하고 중앙 보스를 별도 아레나에 준비한다. 외곽 위치는 작은 회색 표식, 중앙 위치는 큰 붉은 표식으로 구분하되 실제 보스의 정체는 조우 전까지 숨긴다.
...
- 외곽 보스는 작은 회색 표식, 중앙 평가는 큰 붉은 표식으로 사이클 시작 즉시 실제 위치를 표시한다.
