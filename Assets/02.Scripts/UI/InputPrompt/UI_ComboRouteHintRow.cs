...
namespace UPlayGround.UI.InputPrompt
{
    ...
    /// 글리프는 <see cref="UI_InputPromptIcon"/>을 재사용해 활성 디바이스/브랜드 전환을 자동 처리한다.
    /// <see cref="UI_ComboRouteHint"/>가 템플릿으로 복제해 사용한다.
    /// </summary>
    public class UI_ComboRouteHintRow : MonoBehaviour
    {
        [SerializeField] private UI_InputPromptIcon _keyIcon;
