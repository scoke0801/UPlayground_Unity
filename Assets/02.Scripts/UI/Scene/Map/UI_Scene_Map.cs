...
namespace UPlayGround.UI
{
    ...
    /// ■ 프리팹 구조 (필수)
    /// <code>
    /// UI_Scene_Map (Canvas, CanvasLayer = Popup)
    ...
    public partial class UI_Scene_Map : UI_SceneBase
    {
        [Header("컴포넌트")]
        ...
        protected override void OnShow()
        {
            ...
            {
                Debug.LogError("[UI_Scene_Map] MapConfigDatabaseSO가 할당되지 않았습니다.");
                return;
            }
            ...
            if (_config == null)
            {
                Debug.LogError($"[UI_Scene_Map] MapID '{mapId}'에 대한 MinimapIconConfigSO를 찾을 수 없습니다.");
                return;
            }
