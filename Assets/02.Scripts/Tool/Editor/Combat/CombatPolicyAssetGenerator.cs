...
namespace UPlayGround.Tool.Editor.Combat
{
    public static class CombatPolicyAssetGenerator
    {
        ...
        [UPlayGround.EditorTools.UPlaygroundTool("UPlayGround/게임플레이/전투/정책/기본 정책 에셋 생성", priority = UPlayGround.Tool.Editor.UPlaygroundMenuPriority.GameplayCombatTools + 2)]
