...
namespace UPlayGround.AI.BehaviorTree.Editor
{
    ...
    public static partial class MonsterBehaviorTreeJsonImporter
    {
        ...
        [MenuItem("UPlayGround/비헤이비어 트리/JSON/선택 JSON 가져오기", priority = UPlayGround.Tool.Editor.UPlaygroundMenuPriority.BehaviorTreeJson + 4)]
        ...
        [MenuItem("UPlayGround/비헤이비어 트리/JSON/폴더 가져오기", priority = UPlayGround.Tool.Editor.UPlaygroundMenuPriority.BehaviorTreeJson + 5)]
        ...
        [MenuItem("UPlayGround/비헤이비어 트리/JSON/Project 선택 JSON 가져오기", priority = UPlayGround.Tool.Editor.UPlaygroundMenuPriority.BehaviorTreeJson + 6)]
        public static void ImportSelectedProjectJsons()
        {
            ImportJsonFiles(GetSelectedJsonAssetPaths().Select(Path.GetFullPath), "선택 JSON");
        }

        [MenuItem("UPlayGround/비헤이비어 트리/JSON/Project 선택 JSON 가져오기", true, UPlayGround.Tool.Editor.UPlaygroundMenuPriority.BehaviorTreeJson + 6)]
        ...
        [MenuItem("UPlayGround/비헤이비어 트리/JSON/SourceJson 전체 가져오기", priority = UPlayGround.Tool.Editor.UPlaygroundMenuPriority.BehaviorTreeJson + 7)]
