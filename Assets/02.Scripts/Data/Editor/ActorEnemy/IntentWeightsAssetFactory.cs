...
namespace UPlayGround.Data.Enemy.EditorTools
{
    ...
    public static class IntentWeightsAssetFactory
    {
        ...
        [UPlayGround.EditorTools.UPlaygroundTool("UPlayGround/적/의도 가중치/기본 프로필 전체 생성")]
        ...
        [UPlayGround.EditorTools.UPlaygroundTool("UPlayGround/적/의도 가중치/기본 근접 프로필 재생성 (레거시 동등)")]
