...
namespace UPlayGround.UI
{
    ...
    /// 인벤토리 UI
    /// </summary>
    public class UI_Scene_Inventory : UI_SceneBase
    {
        ...
        [SerializeField] private UIInventorySlot _itemPanelPrefab;
        ...
        /// 신 빌더 산출물에서는 UIInputPromptIcon이 스프라이트 글리프를 우선 표시한다.
        /// </summary>
        ...
        public void SetItemClickAnimation(UIInventorySlot slot)
        {
        ...
        private UICommonButtonClickResult RefreshAfterAction(InventoryActionResult result)
        {
            if (result != InventoryActionResult.Success)
            {
                Debug.LogWarning($"[UI_Scene_Inventory] 아이템 액션 실패: {result}");
                return UICommonButtonClickResult.Failed;
            }
