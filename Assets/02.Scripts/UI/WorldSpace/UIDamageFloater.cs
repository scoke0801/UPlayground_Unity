...
namespace UPlayGround.UI
{
    ...
    public class UIDamageFloater : MonoBehaviour
    {
        ...
        public void Init(Camera cam, RectTransform canvasRect, DamageFloaterConfigSO config, UIWorldSpaceHudLayer owner)
        {
            _camera = cam;
