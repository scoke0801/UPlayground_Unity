...
namespace UPlayGround.Data.Event
{
    ...
    public class InteractionEvent : MotionEventBase
    {
        ...
        {
            IInteractable interactable = ActorSvc.Objects?.InteractionHandler?.CurrentClosestInteractable;
        ...
        private static void ShowInteractionFx(IInteractable interactable)
        {
            ...
            ActorSvc.Objects?.ShowFX(FXKeyType.InteractionObjectHitFX, position);
        }
    }
}
